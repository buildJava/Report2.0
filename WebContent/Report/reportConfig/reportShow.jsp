...
<head>
	...
	<script type="text/javascript" src="${ctx }/Report/reportConfig/js/reportShowJson.js?time=.js"></script>
...
<body>
	...
	<div class="auto_content">
		<div class="panel panel-primary">
			...
			<div class="form-btn-group">
				...
				<a id="save_btn" class="form-btn" onclick="openFieldSelect()">字段选择</a>
	...
	<div class="dialog_win" id="dialog_win" style="display:none;">
		<div class="panel-primary panel-border-none padding-lr30" style="max-height:620px; overflow-y:auto;">
			<div class="panel-body">
				<form class="form-group dialog_field_box" style="width:660px;">
				</form>
			</div>
		</div>
	</div>
